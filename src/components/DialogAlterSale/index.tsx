          ...
          <div className="space-y-6 py-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input
                  value={getSaleStatusLabel(sale.sale.sale_status)}
                  disabled
                />
              </div>
              <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      min="0"
                      className="pl-10"
                      {...register("prohibited", { valueAsNumber: true })}
                    />
                  </div>
                </div>
                <div className="space-y-2">
            ...
            {paymentMethod === PaymentMethod.CreditCard && (
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Controller
                    control={control}
                    // Altere para o nome correto do campo esperado no seu Schema (ex: "installments_count")
                    name="installments_count"
                    render={({ field }) => (
                      <Select
                        onValueChange={(value) =>
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-sm font-medium">
                      {sale.sale.installment_total_amount != null
                        ? `R$ ${formatCurrency(Number(sale.sale.total_amount))}`
                        : "—"}
                    </p>
                  </div>
                </div>
                  ...
                  sale.sale.installments_count > 0 && (
                    <div>
                      <h4 className="text-sm font-medium mb-3 flex items-center gap-1.5">
                        <Banknote className="h-3.5 w-3.5" /> Detalhes das
                        Parcelas
                      </h4>
